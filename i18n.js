...
const STRINGS = {
  en: {
    ...
    'settings.feedbackPlaceholder': 'What is missing, or what went wrong? For a bug, the code above helps.',
    'settings.feedbackNote': 'Sent anonymously.',
    'settings.feedbackSend': 'Send',
    'settings.feedbackSent': 'Thank you — sent.',
  ...
  pl: {
    ...
    'settings.feedback': 'Uwagi',
    'settings.feedbackPlaceholder': 'Czego brakuje albo co nie zadziałało? Przy błędzie pomoże kod powyżej.',
    'settings.feedbackNote': 'Wysyłane anonimowo.',
    'settings.feedbackSend': 'Wyślij',
    'settings.feedbackSent': 'Dzięki — wysłane.',
